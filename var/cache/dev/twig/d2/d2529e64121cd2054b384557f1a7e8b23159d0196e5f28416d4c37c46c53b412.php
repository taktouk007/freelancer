...
";
    ...
    <form action=\"";
        ...
        echo "\" method=\"post\" class=\"customform\">
        ";
        // line 8
...
{% endif %}
<div>
    <form action=\"{{ path(\"fos_user_security_check\") }}\" method=\"post\" class=\"customform\">
        {% if csrf_token %}
...
</div>", "@FOSUser/Security/login_content.html.twig", "C:\\wamp64\\www\\freelancer\\app\\Resources\\FOSUserBundle\\views\\Security\\login_content.html.twig");
    }
}
