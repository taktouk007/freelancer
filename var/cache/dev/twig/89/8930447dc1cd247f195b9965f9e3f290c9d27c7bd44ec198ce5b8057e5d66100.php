...
/* user/show.html.twig */
class __TwigTemplate_baa191561bd0ba72016d41d34434f9a56d6f0d602949806b0366a5082614cbf9 extends Twig_Template
{
    ...
    <table>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 22
        echo twig_escape_filter($this->env, $this->getAttribute(($context["user"] ?? $this->getContext($context, "user")), "competence", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Rating</th>
                <td>";
        // line 26
        echo twig_escape_filter($this->env, $this->getAttribute(($context["user"] ?? $this->getContext($context, "user")), "rating", array()), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "user/show.html.twig", "C:\\wamp64\\www\\freelancer\\app\\Resources\\views\\user\\show.html.twig");
    }
}
