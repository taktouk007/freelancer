...
$a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'\\src\\App\\FreelancerBundle\\Entity'))), 'App\\FreelancerBundle\\Entity');
...
$b->setEntityNamespaces(array('AppFreelancerBundle' => 'App\\FreelancerBundle\\Entity'));
